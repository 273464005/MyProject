...
<body>
    ...
    <script type="text/html" id="cz">
        ...
        <a class="layui-btn {{d.zt==0?'layui-btn-warm':'layui-btn'}} layui-btn-xs" lay-event="jy">{{d.zt==0?'<i class="layui-icon layui-icon-close"></i>禁用':'<i class="layui-icon layui-icon-ok"></i>启用'}}</a>
