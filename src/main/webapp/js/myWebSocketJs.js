 ...
 */
function webSocketSendMsg(url,homeId,userId,showMsg){
    var websocket = null;
    ...
    window.setMessageInnerHTML = function(innerHTML) {
        document.getElementById(showMsg).innerHTML += innerHTML + '<br/>';
    }
    ...
    //发送消息
    window.send =  function(inputId) {
        var fsnr = document.getElementById(inputId).value;
        //var message = fsnr + "|" + homeid;
        var message = JSON.stringify({'msg':fsnr,'jsrId':'' });
